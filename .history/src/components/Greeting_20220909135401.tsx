        ...
        <div className="col-md-5">
            <div className="card">
                <div className="card-body">
                   ...
                   <button className='btn btn-warning m-1' onClick={()=>changeMessage('Good morning')}>Good evening</button>
                   <button className='btn btn-danger m-1' onClick={()=>changeMessage('Good morning')}>Good afternoun</button>
                </div>
            </div>
        </div>
    </div>
